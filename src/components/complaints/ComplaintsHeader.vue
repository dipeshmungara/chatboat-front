...
<template>
	<div>
		...
		>
			{{ singleComplaintsHeader.singleProjectTitle }}
		</p>
		<div class="flex">
			<div class="flex items-center mr-10">
				...
				<span
					...
					>{{ singleComplaintsHeader.singleProjectDate }}</span
				>
			</div>
			<div class="flex items-center">
				...
				<span
					class="font-general-medium ml-2 leading-none text-primary-dark dark:text-primary-light"
					>{{ singleComplaintsHeader.singleProjectTag }}</span
				>
			</div>
		</div>
	</div>
